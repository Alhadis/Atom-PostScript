...
class PostScriptPreviewView extends AtomLiveView {
	...
	constructor(state = {}){
		...
		this.observeConfig("postscript-preview.alphaBits", "postscript-preview.resolution");
	}
	...
	registerCommands(){
		return atom.commands.add(this.element, {
			"postscript-preview:zoom-in":  () => this.panAndZoom.zoom += 0.25,
			"postscript-preview:zoom-out": () => this.panAndZoom.zoom -= 0.25,
		});
	}
